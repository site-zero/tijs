...
test('zoom', function () {
  ...
  rect.zoom({ x: 2, y: 3 });
  let rect2 = new Rects.Rect({ width: 100, height: 180, x: 125, y: 130 });
  expect(rect).toStrictEqual(rect2);

  rect = new Rects.Rect({ top: 100, left: 100, width: 50, height: 60 });
  // x, y 不变，宽度变成原来的 0.5 倍，高度成为原来的 0.6 倍
  rect.zoom({ x: 0.5, y: 0.6 });
  rect2 = new Rects.Rect({ width: 25, height: 36, x: 125, y: 130 });
  expect(rect).toStrictEqual(rect2);
});
...
test('centreTo', function () {
  ...
  rect = new Rects.Rect({ top: 100, left: 80, width: 140, height: 150 });
  rect.centreTo({ width: 200, height: 220, top: 10, left: 10 });
  rect2 = new Rects.Rect({ x: 110, y: 120, width: 140, height: 150 });
  expect(rect).toStrictEqual(rect2);
...
test('union', function () {
  ...
  let rect4 = new Rects.Rect({ top: 12, left: 25, right: 110, bottom: 90 });
  rect1.union(rect2, rect3, rect4);
  let rect5 = new Rects.Rect({ top: 0, left: 5, right: 130, bottom: 130 });
...
test('overlap', function () {
  ...
  let rect5 = new Rects.Rect({ top: 15, left: 25, right: 100, bottom: 90 });
  expect(rect1).toStrictEqual(rect5);
});
...
test('contains', function () {
  ...
  rect2 = new Rects.Rect({ top: 10, left: 9, right: 130, bottom: 120 });
  expect(rect1.contains(rect2)).eq(false);

  rect2 = new Rects.Rect({ top: 10, left: 10, right: 131, bottom: 120 });
  expect(rect1.contains(rect2)).eq(false);
});
...
test('containsX', function () {
  ...
  rect2 = new Rects.Rect({ top: 10, left: 15, right: 160, bottom: 120 });
  expect(rect1.containsX(rect2)).eq(false);

  rect2 = new Rects.Rect({ top: 10, left: 8, right: 120, bottom: 120 });
  expect(rect1.containsX(rect2)).eq(false);
});
...
test('containsY', function () {
  ...
  rect2 = new Rects.Rect({ top: 15, left: 10, right: 130, bottom: 100 });
  expect(rect1.containsY(rect2)).eq(true);

  rect2 = new Rects.Rect({ top: 15, left: 10, right: 130, bottom: 121 });
...
test('isOverlap', function () {
  ...
  let rect3 = new Rects.Rect({ top: 61, left: 62, right: 150, bottom: 150 });
...
test('area', function () {
  ...
  rect = new Rects.Rect({ top: 10, left: 10, width: 50, height: 60 });
