...
const en_us = {
  ...
  "info-gtlt": "${minValue} (excl) to ${maxValue} (excl)",
  "info-gtelt": "${minValue} (incl) to ${maxValue} (excl)",
  "info-gtlte": "${minValue} (excl) to ${maxValue} (incl)",
  "info-gtelte": "${minValue} (incl) to ${maxValue} (incl)",
  ...
  "max": "Latest",
  "max-val": "Latest Date",
  "max-included": "Include Latest Date",
  "min": "Earliest",
  "min-val": "Earliest Date",
  "min-included": "Include Earliest Date",
  "included": "Included",
  "excluded": "Excluded",
};
const zh_cn = {
