...
const en_us = {
  "com-name": "Date Range",
  "example-as-array": "Array Value",
  "example-as-info": "Form Info",
  "example-as-obj": "Comparison Object",
  "edit-title": "Edit Date Range",
  "scope": "Date Range",
  "info-NA": "No Date Range",
  "info-eq": "Equal to ${minValue}",
  "info-ne": "Not equal to ${minValue}",
  "info-gtlt": "From ${minValue} (excl) to ${maxValue} (excl)",
  "info-gtelt": "From ${minValue} (incl) to ${maxValue} (excl)",
  "info-gtlte": "From ${minValue} (excl) to ${maxValue} (incl)",
  "info-gtelte": "From ${minValue} (incl) to ${maxValue} (incl)",
  "info-lt": "Before ${maxValue} (excl)",
  "info-lte": "Before ${maxValue} (incl)",
  "info-gt": "After ${minValue} (excl)",
  "info-gte": "After ${minValue} (incl)",
  "expt-NA": "No Date Range Set",
  ...
  "max": "To",
  "max-val": "End Date",
  "max-included": "Include End Date",
  "min": "From",
  "min-val": "Start Date",
  "min-included": "Include Start Date",
  "included": "Included",
  "excluded": "Excluded",
};
const zh_cn = {
  ...
  "info-gtlt": "从 ${minValue}(不包括) 至 ${maxValue} (不包括)",
  "info-gtelt": "从 ${minValue}(包括) 至 ${maxValue} (不包括)",
  "info-gtlte": "从 ${minValue}(不包括) 至 ${maxValue} (包括)",
  "info-gtelte": "从 ${minValue}(包括) 至 ${maxValue} (包括)",
  "info-lt": "${maxValue} 以前 (不包括)",
  "info-lte": "${maxValue} 以前 (包括)",
  "info-gt": "${minValue} 以后 (不包括)",
  "info-gte": "${minValue} 以后 (包括)",
  "expt-NA": "未设置日期范围",
  "expt-eq": "Date == ${minValue}",
  "expt-ne": "Date != ${minValue}",
  "expt-gtlt": "${minValue} < Date < ${maxValue}",
