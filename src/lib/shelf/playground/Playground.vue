...
import { CssUtils, Rects, Size2D, TiStore } from '../../../core';
import {
ExampleState,
PlaygroundProps,
SubComEvent,
...
let s = TiStore.local.getString('Ti-Demo-Live-Bg', 'fill');
...
-------------------------------------------------------*/
const hasSyntaxErr = computed(() =>
  _example.value.syntaxErr ? true : false,
);
...
function ToggleLiveBgMode() {
  ...
  TiStore.local.set('Ti-Demo-Live-Bg', _live_bg_mode.value);
}
