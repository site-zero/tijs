 ...
 */
import { Rect } from "src/_type/core-types";
import { TipBoxProps } from "./lib-tip-types";
...
export function useTipsApi() {
     ...
     * 注册是提示信息
     */
    const _all_tips = new Map<string, TipSetup>();
    /**
     * 页面上显示的提示信息对象
     */
    const _instances = new Map<number, TipObj>();
